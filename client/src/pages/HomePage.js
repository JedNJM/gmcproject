...
const HomePage = () => {
  ...
  <div className="carousel-inner">
    <div className="carousel-item">
      <div className="page-header section-height-75 m-3 border-radius-xl" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1537511446984-935f663eb1f4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1920&q=80")'}}>
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="info-horizontal bg-gradient-primary border-radius-xl p-5">
              <div className="icon">
                <svg width="25px" height="25px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                  <title>office</title>
              ...
              <div className="description ps-5">
                <h5 className="text-white">Netflix's 'Shuffle Play' feature</h5>
                <p className="text-white">The Arctic Ocean freezes every winter and much of the sea-ice then thaws every summer, and that process will continue whatever.</p>
                <a href="javascript:;" className="text-white icon-move-right">
                  More about us
          ...
          <div className="col-lg-6">
            <div className="info-horizontal bg-light border-radius-xl p-5">
              <div className="icon">
                <svg className="text-primary" width="25px" height="25px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                  <title>ungroup</title>
                  <g id="Basic-Elements" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                    <g id="Rounded-Icons" transform="translate(-2170.000000, -442.000000)" fill="#FFFFFF" fillRule="nonzero">
                      <g id="Icons-with-opacity" transform="translate(1716.000000, 291.000000)">
                        <g id="ungroup" transform="translate(454.000000, 151.000000)">
                          <path className="color-background" d="M38.1818182,10.9090909 L32.7272727,10.9090909 L32.7272727,30.9090909 C32.7272727,31.9127273 31.9127273,32.7272727 30.9090909,32.7272727 L10.9090909,32.7272727 L10.9090909,38.1818182 C10.9090909,39.1854545 11.7236364,40 12.7272727,40 L38.1818182,40 C39.1854545,40 40,39.1854545 40,38.1818182 L40,12.7272727 C40,11.7236364 39.1854545,10.9090909 38.1818182,10.9090909 Z" id="Path" />
                          <path className="color-foreground" d="M27.2727273,29.0909091 L1.81818182,29.0909091 C0.812727273,29.0909091 0,28.2781818 0,27.2727273 L0,1.81818182 C0,0.814545455 0.812727273,0 1.81818182,0 L27.2727273,0 C28.2781818,0 29.0909091,0.814545455 29.0909091,1.81818182 L29.0909091,27.2727273 C29.0909091,28.2781818 28.2781818,29.0909091 27.2727273,29.0909091 Z" id="Path" />
                        </g>
                      </g>
                    </g>
                  </g>
    ...
    <div className="carousel-item">
      <div className="page-header section-height-75 m-3 border-radius-xl" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1543269865-cbf427effbad?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1920&q=80")'}}>
        <span className="mask bg-gradient-dark" />
        <div className="container">
          <div className="row">
            <div className="col-lg-6 my-auto">
    ...
    <div className="row text-center ">
      <div className="col-lg-3 col-md-6">
        <div className="info">
          ...
          <h5 className="mt-2">Life & Work Balance</h5>
          <p>All the opportunities present are for providing deals.</p>
        </div>
      </div>
      <div className="col-lg-3 col-md-6">
        <div className="info">
          ...
          <h5 className="mt-2">Mix &amp; Match</h5>
          <p>Always Providing Quality opportunities from the best</p>
        </div>
      </div>
      <div className="col-lg-3 col-md-6">
        <div className="info">
          ...
          <h5 className="mt-2">Quick Answers</h5>
          <p>Leave comments on opportunities and receive answers from the company Quickly.</p>
        </div>
      </div>
      <div className="col-lg-3 col-md-6">
        <div className="info">
          <div className="icon icon-shape mx-auto">
            <svg className="text-info" width="25px" height="25px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
          ...
          <h5 className="mt-2">Contracts</h5>
          <p>All opportunities have contracts.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="container">
    <div className="row">
      <div className="col-md-5 ms-auto me-auto text-center">
        ...
        <h3 className=" text-primary mb-0 mt-4">Company Culture</h3>
        <h3>We provide you with the newest opportunities</h3>
      ...
      <div className="col-md-4 ms-auto my-auto">
        <a href="javascript:;">
          <div className="card card-background tilt" data-tilt="">
            <div className="full-background" style={{backgroundImage: 'url("https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/team-working.jpg")'}} />

            <div className="card-body pt-7 text-center">
              <div className="icon icon-lg up mb-3">
              ...
              <h1 className="text-white up mb-0">Search and Discover!</h1>
              <p className="lead up">Website visitors</p>
              <button type="button" className="btn btn-white btn-lg mt-3 up">Get Started</button>
            </div>
          </div>
        </a>
      </div>

      <div className="col-md-5 me-auto my-auto ms-5">
    ...
    <div className="row">
      <div className="col-md-5 ms-auto my-auto">
        ...
        <div className="p-3 info-horizontal d-flex">
          <div>
            ...
            <p>
              Whether it’s htmlFor work or even the next family vacation, Trello helps your team.
            </p>
          </div>
        </div>
      ...
      <div className="col-md-4 me-auto my-auto ms-5">
        <a href="javascript:;">
          <div className="card card-background tilt" data-tilt="">
            <div className="full-background" style={{backgroundImage: 'url("https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/coffee-shop.jpg")'}}>
            ...
            <div className="card-body pt-7 text-center">
              ...
              <h1 className="text-white up mb-0">Talk and Meet!</h1>
              <p className="lead up">Social activities</p>
              <button type="button" className="btn btn-white btn-lg mt-3 up">Get Started</button>
            </div>
          </div>
        </a>
